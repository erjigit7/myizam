...
def main() -> None:
    ...
    print("\nВывод: детектор обучен на программной подмене ЦИФР — цифровые порчи ловит,"
          "\nсловесные ('трех'→'девяти') — нет. Подтверждает shadow-режим и план"
          "\nдообучения на юридическом домене (фаза 2 проекта).")
